  ...
  blogs: [
    {
      ...
      description:
        "A deep dive into how attention mechanisms revolutionized neural machine translation. Explained with simple language, visuals, and math that a high school student can understand.",
      url: "/blog/attention-nmt",
      date: "March 4, 2026",
      readTime: "15 min read",
      tags: ["NLP", "Deep Learning", "Attention", "Neural Networks"],
      gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
      icon: "\uD83E\uDDE0",
      component: "AttentionNMT",
    },
  ],
};
